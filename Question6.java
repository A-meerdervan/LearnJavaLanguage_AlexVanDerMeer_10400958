...
class CartoonTest { 
   ...
   public static void main(String[] args) {
	   CartoonCharacter FredF = new CartoonCharacter("Fred Flintstone", "Blue", 42);
	   CartoonCharacter WilmF = new CartoonCharacter("Wilma Flintstone", "Red", 63);
	   CartoonCharacter BarR = new CartoonCharacter("Barney Rubble", "Yellow", 2);
	   FredF.displayMe();
	   WilmF.displayMe();
	   BarR.displayMe();
	   System.out.println(BarR.favouriteColour);
	   CartoonCharacter.count += 5;
